...
public class Settings {
    private static int get(String settingName, int defaultValue) {
        return LaunchActivity.instance.getApplicationContext().getSharedPreferences("re_extera", 0).getInt(settingName, defaultValue);
    }

    private static String get(String settingName, String defaultValue) {
        return LaunchActivity.instance.getApplicationContext().getSharedPreferences("re_extera", 0).getString(settingName, defaultValue);
    }

    private static boolean get(String settingName, boolean defaultValue) {
        return LaunchActivity.instance.getApplicationContext().getSharedPreferences("re_extera", 0).getBoolean(settingName, defaultValue);
    }

    private static void set(String settingName, int value) {
        LaunchActivity.instance.getApplicationContext().getSharedPreferences("re_extera", 0).edit().putInt(settingName, value).apply();
    }

    private static void set(String settingName, String value) {
        LaunchActivity.instance.getApplicationContext().getSharedPreferences("re_extera", 0).edit().putString(settingName, value).apply();
    }

    private static void set(String settingName, boolean value) {
        LaunchActivity.instance.getApplicationContext().getSharedPreferences("re_extera", 0).edit().putBoolean(settingName, value).apply();
    }
